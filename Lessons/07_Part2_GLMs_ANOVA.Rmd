...
Levels: the different values in the factor 
balanced design: for all the levels there is the same number of observations 
...
- need to worry about interactive effects 
