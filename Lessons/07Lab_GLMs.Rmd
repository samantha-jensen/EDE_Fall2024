...
comparison <- lm(EPAair$Ozone ~ EPAair$PM2.5)
summary(comparison)
...
OzoneALL.reg <- lm(data = EPAair, PM2.5 ~ Ozone + mean_Lat + mean_Lng + Year + Month)
...
OzoneALL.reg <- lm(data = EPAair, PM2.5 ~ Ozone + mean_Lat + mean_Lng + Month)
summary(OzoneALL.reg)
```
